...
?>
	<div class="wrap">
		...
		<?php
			if ( isset ( $_GET['tab'] ) ) empty_admin_tabs($_GET['tab']); else empty_admin_tabs('info'); /* = TAB PREDETERMINADA*/
		?>
		<div id="poststuff">
			...
			<?php
				...
				if ( $pagenow == 'options-general.php' && $_GET['page'] == 'empty' ) {
					...
					switch ( $tab ){
						...
						<?php	
						break;
						case 'style' : // OPCIONES EN STYLE, POR EJEMPLO: 
						?>
							<div class="postbox">
